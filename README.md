...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Bedulbottzy/banteros)
...
```bash
git clone https://github.com/Bedulbottzy/banteros
cd banteros
git clone https://github.com/Bedulbottzy/node_modules
node index.js
```
